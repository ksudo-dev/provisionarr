...
Search text is interpreted into a small media intent schema. Deterministic server code resolves titles, seasons, users, and ARR records. I designed request handling to reject arbitrary URLs, shell instructions, and user-supplied raw ARR request bodies.
