...
I completed these technical namespace checks on 2026-08-31. This is not a trademark opinion or legal clearance.
...
I keep the Node package private and have not published it to npm. I don't claim or require a custom domain for Provisionarr 1.0.
...
- no intended GHCR image before I added the first release workflow; and
- no active DNS records or RDAP registration records for the `.com`, `.net`,
  `.org`, and `.dev` names. I did not check other extensions.
